...
public interface VoucherRepository extends JpaRepository<Voucher, Long> {
    ...
    @Query("""
                select  v.code,v.condition, v.discountAmount, v.validFrom, v.validTo, v.description
                from Voucher v
    ...
    @Query("""
                select v.id, v.code,v.condition, v.discountAmount, v.validFrom, v.validTo, v.description
                from Voucher v
                where v.code = :code
                group by v.id, v.code,v.condition,v.discountAmount, v.validFrom, v.validTo, v.description
            """)
